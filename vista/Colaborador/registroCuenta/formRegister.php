    ...
    <div class="card-body">
        ...
        <form method="post" action="crearColaborador.php">
            <div class="mb-3">
                ...
                <input type="email" id="colabCorreo" name="correo" class="form-control" placeholder="tu@correo.com" required />
            </div>
            <div class="mb-3">
                <label class="form-label" for="colabClave">Contraseña</label>
                <input type="password" id="colabClave" name="clave" class="form-control" placeholder="Crea una contraseña" required />
            </div>
            <div class="mb-3">
                <label class="form-label" for="colabConfirmClave">Confirmar Contraseña</label>
                <input type="password" id="colabConfirmClave" name="confirm_clave" class="form-control" placeholder="Confirma tu contraseña" required />
            </div>
            <div class="mb-3">
                <label class="form-label" for="colabNombre">Nombre de la Entidad/Persona</label>
                <input type="text" id="colabNombre" name="nombre" class="form-control" placeholder="Nombre del colaborador" required />
            </div>
            <div class="mb-3">
                <label class="form-label" for="colabTipoResiduo">Tipo de Residuo Principal que Gestiona</label>
                <input type="text" id="colabTipoResiduo" name="tipo_residuo" class="form-control" placeholder="Ej: Plástico, Papel, Vidrio" required />
            </div>
            <div class="mb-3">
                <label class="form-label" for="colabServicio">Servicio Ofrecido</label>
                <input type="text" id="colabServicio" name="servicio_ofrecido" class="form-control" placeholder="Ej: Recolección, Centro de Acopio" required />
            </div>
